...
@Config
public class OldLocateSampleCommand extends CommandBase {
    ...
    public OldLocateSampleCommand(SampleType sampleType) {
    ...
    public void execute() {
        ...
        if(detectedSample == null && move.milliseconds() < 100) {
            ...
            System.out.println("Target Pose: " + targetPose.x + "," + targetPose.y + "," + targetPose.heading);
            robot.drivetrain.set(getPower(robotPose, targetPose));
